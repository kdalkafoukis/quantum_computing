...
for u, v in edges:
    for i in range(colours):
        h_cost -= sX(u * colours + i) * sX(v * colours + (i+1) % colours) + sX(v * colours + i) * sX(u * colours + (i+1) % colours)
...
for vertice in range(vertices):
    for i in range(colours):
        h_driver -= sX(vertice * colours + i) * sX(vertice * colours + (i+1) % colours) + sY(vertice * colours + i) * sY(vertice * colours + (i+1) % colours)
